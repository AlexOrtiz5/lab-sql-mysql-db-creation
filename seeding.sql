...
VALUES (1, '3K096I98581DHSNUP', 'Volkswagen', 'Tiguan', 2019, 'Blue'),
       ...
       (5, 'DAM41UDN3CHU2WVF67', 'Volvo', 'V60', 2019, 'Gray'),
       (6, 'DAM41UDN3CHU2WVF6', 'Volvo', 'V60 Cross Country', 2019, 'Gray');
       
-- SELECT * FROM cars;

INSERT INTO customers (customer, cust_id, cust_name, cust_phone, cust_email, cust_address, cust_city, cust_state, cust_country, cust_zipcode)
...
INSERT INTO salespersons (salesperson, staff_id, name, store)
